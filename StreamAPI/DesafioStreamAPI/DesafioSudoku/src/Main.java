...
public class Main {
    ...
    private static void inputNumber() {
        ...
        if (board.isBoardValido()) {
            System.out.println("Jogada válida! O tabuleiro continua correto.");
        } else {
            System.out.println("Atenção! Sua última jogada criou um erro no tabuleiro (número repetido na linha, coluna ou box");
        }
    }
    ...
    private static void showCurrentGame() {
        ...
        System.out.println("Seu jogo se encontra da seguint forma");
    ...
    private static int runUntilGetValidNumber(final int min, final int max) {
        ...
        while (current < min || current > max) {
            System.out.printf("Informe um número estre %s e %s\n", min, max);
